...
if (WebUI.verifyElementPresent(findTestObject('OR_HomePage/Obj_PrimeHealthCare'), 1, FailureHandling.STOP_ON_FAILURE)) {
    WebUI.click(findTestObject('OR_HomePage/Obj_PrimeHealthCare'))

    WebUI.click(findTestObject('OR_Alert/Obj_Hide'))

    WebUI.getUrl()

    WebUI.getText(findTestObject('OR_HomePage/Obj_PrimeHealthCare'))
}
