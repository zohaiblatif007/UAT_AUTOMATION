...
WebUI.waitForElementPresent(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_Healthconcern/button_Edit'), 
    GlobalVariable.timeout)

WebUI.click(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_Healthconcern/button_Edit'))
...
WebUI.click(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_Healthconcern/Obj_AlertUpdate'))

WebUI.verifyElementText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_Healthconcern/Obj_AlertUpdate'), 
    'successRecord updated successfully.Hide')

'Wait until Alert Disapear'
WebUI.waitForElementNotPresent(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_Healthconcern/Obj_AlertUpdate'), 
    GlobalVariable.timeout)
