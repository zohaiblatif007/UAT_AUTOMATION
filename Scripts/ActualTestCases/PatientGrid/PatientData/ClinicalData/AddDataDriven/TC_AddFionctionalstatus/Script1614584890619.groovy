...
WebUI.setText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_Funtionalstatus/Obj_inputcode'), findTestData(
        'DF_CMRData/DF_ClinicalSection/FunctionalStatus').getValue(1, 1))
...
'Enter the Date'
WebUI.setText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_Funtionalstatus/Obj_date'),  findTestData(
        'DF_CMRData/DF_ClinicalSection/FunctionalStatus').getValue(2, 1))
