...
WebUI.setText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_VitalSigns/Obj_inputemperature'), findTestData(
        'DF_CMRData/DF_ClinicalSection/TD_VitalSigns').getValue(2, 1))

'Enter the pulse'
WebUI.setText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_VitalSigns/Obj_inpupulse'), findTestData(
        'DF_CMRData/DF_ClinicalSection/TD_VitalSigns').getValue(3, 1))

'Enter the Resp Rate'
WebUI.setText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_VitalSigns/Obj_input_Respiratory'), findTestData(
        'DF_CMRData/DF_ClinicalSection/TD_VitalSigns').getValue(4, 1))

'Enter the Systolic BP'
WebUI.setText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_VitalSigns/Obj_inputDecrease'), findTestData(
        'DF_CMRData/DF_ClinicalSection/TD_VitalSigns').getValue(5, 1))

'Enter the Diasistolic_BP'
WebUI.setText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_VitalSigns/Obj_input_diastolic'), findTestData(
        'DF_CMRData/DF_ClinicalSection/TD_VitalSigns').getValue(6, 1))

'Enter the Weight'
WebUI.setText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_VitalSigns/Obj_inputweight'), findTestData(
        'DF_CMRData/DF_ClinicalSection/TD_VitalSigns').getValue(7, 1))

'Enter the Height'
WebUI.setText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_VitalSigns/Obj_inputHeight'), findTestData(
        'DF_CMRData/DF_ClinicalSection/TD_VitalSigns').getValue(8, 1))

'Enter the BMI Value'
WebUI.setText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_VitalSigns/Obj_inputBMI'), findTestData(
        'DF_CMRData/DF_ClinicalSection/TD_VitalSigns').getValue(9, 1))

'Enter the BSA Value'
WebUI.setText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_VitalSigns/Obj_inputBSA'), findTestData(
        'DF_CMRData/DF_ClinicalSection/TD_VitalSigns').getValue(10, 1))

'Enter the O2 Saturation Value'
WebUI.setText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_VitalSigns/Obj_inputo2Saturation'), findTestData(
        'DF_CMRData/DF_ClinicalSection/TD_VitalSigns').getValue(11, 1))

'Enter the value_inhaledOxygenConcentration'
WebUI.setText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_VitalSigns/Obj_inputinhaledOxygen'), 
    findTestData('DF_CMRData/DF_ClinicalSection/TD_VitalSigns').getValue(12, 1))
