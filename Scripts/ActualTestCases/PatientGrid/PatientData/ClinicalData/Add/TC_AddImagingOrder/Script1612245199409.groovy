...
WebUI.setText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_ImagingOrder/Obj_inputlabobservations'), findTestData(
        'DF_CMRData/DF_ClinicalSection/TD_ImagingOrder').getValue(2, 1))
...
WebUI.setText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_ImagingOrder/Obj_inputEffectiveDate'), findTestData(
        'DF_CMRData/DF_ClinicalSection/TD_ImagingOrder').getValue(3, 1))
...
WebUI.waitForElementClickable(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_ImagingOrder/Obj_li_Abnormal'), 
    GlobalVariable.timeout)

WebUI.click(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_ImagingOrder/Obj_li_Abnormal'))
...
WebUI.verifyElementText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_ImagingOrder/Obj_Alertsaved'), findTestData(
        'DF_CMRData/DF_ClinicalSection/TD_ImagingOrder').getValue(6, 1))
...
'Verify that Alert Comes After Save Button Clicked'
WebUI.verifyElementText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_ImagingOrder/td_oprovider'), findTestData(
        'DF_CMRData/DF_ClinicalSection/TD_ImagingOrder').getValue(7, 1))

'Verify that Alert Comes After Save Button Clicked'
WebUI.verifyElementText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_ImagingOrder/Obj_td_date'), findTestData(
        'DF_CMRData/DF_ClinicalSection/TD_ImagingOrder').getValue(8, 1))

'Verify that Alert Comes After Save Button Clicked'
WebUI.verifyElementText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_ImagingOrder/td_date - Copy'), findTestData(
        'DF_CMRData/DF_ClinicalSection/TD_ImagingOrder').getValue(9, 1))

'Verify that Alert Comes After Save Button Clicked'
WebUI.verifyElementText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_ImagingOrder/td_date - Copy (1)'), findTestData(
        'DF_CMRData/DF_ClinicalSection/TD_ImagingOrder').getValue(10, 1))

'Verify that Alert Comes After Save Button Clicked'
WebUI.verifyElementText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_ImagingOrder/td_date - Copy (2)'), findTestData(
        'DF_CMRData/DF_ClinicalSection/TD_ImagingOrder').getValue(11, 1))
