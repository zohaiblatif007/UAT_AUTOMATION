...
WebUI.waitForElementClickable(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_LabResults/Obj_li_Osteoarthritis'), 
    GlobalVariable.timeout)

'Select the Analyte'
WebUI.click(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_LabResults/Obj_li_Osteoarthritis'))
...
WebUI.waitForElementClickable(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_LabResults/Obj_li_Amdinocillin'), 
    GlobalVariable.timeout)

'Click on desired Value'
WebUI.click(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_LabResults/Obj_li_Amdinocillin'))
...
WebUI.verifyElementText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_LabResults/Obj_Alertsaved'), findTestData(
        'DF_CMRData/DF_ClinicalSection/TD_LabResults').getValue(6, 1))
...
WebUI.verifyElementText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_LabResults/Obj_td_panel'),findTestData(
        'DF_CMRData/DF_ClinicalSection/TD_LabResults').getValue(7, 1))


WebUI.verifyElementText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_LabResults/Obj_td_ptext1'), findTestData(
        'DF_CMRData/DF_ClinicalSection/TD_LabResults').getValue(8, 1))


WebUI.verifyElementText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_LabResults/Obj_td_ptext2'), findTestData(
        'DF_CMRData/DF_ClinicalSection/TD_LabResults').getValue(9, 1))


WebUI.verifyElementText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_LabResults/Obj_td_ptext3'), findTestData(
        'DF_CMRData/DF_ClinicalSection/TD_LabResults').getValue(10, 1))


WebUI.verifyElementText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_LabResults/Obj_td_ptext4'), findTestData(
        'DF_CMRData/DF_ClinicalSection/TD_LabResults').getValue(11, 1))


WebUI.verifyElementText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_LabResults/Obj_td_result'), findTestData(
        'DF_CMRData/DF_ClinicalSection/TD_LabResults').getValue(12, 1))


WebUI.verifyElementText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_LabResults/Obj_td_value'), findTestData(
        'DF_CMRData/DF_ClinicalSection/TD_LabResults').getValue(13, 1))
...
WebUI.verifyElementText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_LabResults/Obj_td_range'), findTestData(
        'DF_CMRData/DF_ClinicalSection/TD_LabResults').getValue(15, 1))

WebUI.verifyElementText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_LabResults/Obj_td_status'), findTestData(
        'DF_CMRData/DF_ClinicalSection/TD_LabResults').getValue(16, 1))
