...
WebUI.waitForElementClickable(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_Immunization/li_Vaccine'), 
    GlobalVariable.timeout)

'Click on the Vaccination'
WebUI.click(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_Immunization/li_Vaccine'))
