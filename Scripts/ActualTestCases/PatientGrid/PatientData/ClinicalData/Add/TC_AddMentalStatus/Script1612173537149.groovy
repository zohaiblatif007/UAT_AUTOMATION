...
WebUI.waitForElementClickable(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_MentalStatus/Obj_li_Spirometry'), 
    GlobalVariable.timeout)

'Select the Condition'
WebUI.click(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_MentalStatus/Obj_li_Spirometry'))

'Set the Date'
WebUI.setText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_MentalStatus/Obj_Date'), '01032021')
