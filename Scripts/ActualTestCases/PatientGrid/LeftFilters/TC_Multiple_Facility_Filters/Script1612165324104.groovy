...
if (WebUI.verifyElementPresent(findTestObject('OR_PatientGrid/OR_LeftFilters/LeftFiltersObjects/OR_Facility/Obj_SelectFacility'), 
    ...
    WebUI.click(findTestObject('Object Repository/OR_PatientGrid/OR_LeftFilters/LeftFiltersObjects/OR_Enrollment/Obj_Enrollment'))
    ...
    WebUI.verifyElementPresent(findTestObject('OR_PatientGrid/OR_LeftFilters/GridObjects/Obj_MHPN'), 10)
    ...
    //WebUI.verifyElementPresent(findTestObject('OR_PatientGrid/OR_LeftFilters/GridObjects/Obj_Eligible (CCM), Suspended (Readmission)'), 10)
    WebUI.verifyElementPresent(findTestObject('OR_PatientGrid/OR_LeftFilters/OR_LeftFilterParentObjects/Page_Welcome to Persivia (1)/td_Active (CCM) (1)'), 
        10)
