...
'Verify Reject Validation Message'
WebUI.callTestCase(findTestCase('Utility_Functions/UF_Validation Message/UF_RejectMessage'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Utility_Functions/UF_CarePlanGrid/UF_StatusGrid/UF_Reject'), [:], FailureHandling.STOP_ON_FAILURE)
