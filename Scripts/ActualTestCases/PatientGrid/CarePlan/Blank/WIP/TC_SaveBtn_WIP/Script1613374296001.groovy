...
WebUI.callTestCase(findTestCase('Utility_Functions/UF_CarePlanGrid/UF_StatusGrid/UF_WIP'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Utility_Functions/UF_CarePlanGrid/UF_WIP_Data'), [:], FailureHandling.STOP_ON_FAILURE)
