...
'Verify "Are you sure to Approve" Validation Message'
...
WebUI.callTestCase(findTestCase('Utility_Functions/UF_Validation Message/UF_ApprovedMessage'), [:], FailureHandling.STOP_ON_FAILURE)

Thread.sleep(2000)

'Click On Title From Care Plan Tab'
WebUI.click(findTestObject('Object Repository/OR_PatientGrid/OR_PatientData/OR_NonClinicalSection/OR_CarePlan/OR_Title/Obj_Title'))

WebUI.callTestCase(findTestCase('Utility_Functions/UF_CarePlanGrid/UF_Common_Data'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Utility_Functions/UF_CarePlanGrid/UF_Reject_Approve_Data'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Utility_Functions/UF_CarePlanGrid/UF_StatusGrid/UF_Approved'), [:], FailureHandling.STOP_ON_FAILURE)
