...
WebUI.setText(findTestObject('OR_PatientGrid/OR_SearchPatient/OR_Search/OR_Input_Search_Field/Obj_inputSearch'), findTestData('DF_CMRData/TD_Search').getValue(1, 1))
...
WebUI.verifyEqual(Type_Text, findTestData('DF_CMRData/TD_Search').getValue(1, 1))
...
WebUI.click(findTestObject('OR_PatientGrid/Assessment/OR_Assessment/Obj_AsthmaCheckbox'))
