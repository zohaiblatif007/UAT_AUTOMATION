...
WebUI.callTestCase(findTestCase('Utility_Functions/UF_OpenApplication'), [('SiteUrl') : ''], FailureHandling.STOP_ON_FAILURE)
...
String Actual_Title = WebUI.getText(findTestObject('null'))
...
WebUI.callTestCase(findTestCase('Utility_Functions/UF_NotesGrid/Grid'), [:], FailureHandling.STOP_ON_FAILURE)
